...
@test "toggle_plugin_mpi_np_1" {
  ...
  count_0=$(toggle_count_traces 0)
  count_1=$(toggle_count_traces 1)
  count_2=$(toggle_count_traces 2)
...
toggle_count_vpids() {
  ...
  echo $traces | sed -e "s/, { vpid = /\nvpid,/g" | grep vpid | awk '{ split($0,a,","); print a[2] }' | sort | uniq | grep . | wc -l
}
...
@test "toggle_plugin_mpi_np_2" {
  ...
  count_0=$(toggle_count_vpids 0)
  count_1=$(toggle_count_vpids 1)
  count_2=$(toggle_count_vpids 2)
